...
xinput --map-to-output 'Wacom HID 52AE Pen stylus' eDP
xinput --map-to-output 'Wacom HID 52AE Pen eraser' eDP
xinput --map-to-output 'Wacom HID 52AE Finger touch' eDP
